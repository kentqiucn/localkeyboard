...
class Translations implements BaseTranslations<AppLocale, Translations> {
  ...
  late final TranslationsRemoteKeyboardEn remoteKeyboard = TranslationsRemoteKeyboardEn.internal(_root);
}
...
// Path: remoteKeyboard
class TranslationsRemoteKeyboardEn {
  TranslationsRemoteKeyboardEn.internal(this._root);
  ...
  /// en: 'Enter receiver address (IP:Port)'
  String get enterAddress => 'Enter receiver address (IP:Port)';

  late final TranslationsRemoteKeyboardReceiverEn receiver = TranslationsRemoteKeyboardReceiverEn.internal(_root);
  late final TranslationsRemoteKeyboardSenderEn sender = TranslationsRemoteKeyboardSenderEn.internal(_root);
}
...
class TranslationsRemoteKeyboardReceiverEn {
  TranslationsRemoteKeyboardReceiverEn.internal(this._root);
  ...
  /// en: 'Receive Input'
  String get title => 'Receive Input';

  /// en: 'Start listening to receive keyboard input from remote devices. Text typed on connected devices will appear here and be copied to your clipboard.'
  String get description =>
      'Start listening to receive keyboard input from remote devices. Text typed on connected devices will appear here and be copied to your clipboard.';

  /// en: 'Listening'
  String get listening => 'Listening';

  /// en: 'Start Listening'
  String get start => 'Start Listening';

  /// en: 'Stop Listening'
  String get stop => 'Stop Listening';

  /// en: 'Connect at'
  String get address => 'Connect at';
...
class TranslationsRemoteKeyboardSenderEn {
  TranslationsRemoteKeyboardSenderEn.internal(this._root);
  ...
  /// en: 'Send Input'
  String get title => 'Send Input';

  /// en: 'Connect to a remote device and send keyboard input. Text you type here will appear on the connected device.'
  String get description => 'Connect to a remote device and send keyboard input. Text you type here will appear on the connected device.';

  /// en: 'Connected'
  String get connected => 'Connected';

  /// en: 'Scan for Receivers'
  String get scan => 'Scan for Receivers';

  /// en: 'Scanning...'
  String get scanning => 'Scanning...';

  /// en: 'Enter Address Manually'
  String get manual => 'Enter Address Manually';
  ...
  /// en: 'Type here to send text to the remote device...'
  String get inputHint => 'Type here to send text to the remote device...';

  /// en: 'Text is sent in real-time as you type. Use paste button to send clipboard content.'
  String get inputDescription => 'Text is sent in real-time as you type. Use paste button to send clipboard content.';
}
